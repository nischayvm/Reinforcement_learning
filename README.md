...
The rendered transcripts and their source caption tracks are in [captions/](captions/README.md). The Markdown files preserve the caption text, with timestamp links back to the corresponding video.
